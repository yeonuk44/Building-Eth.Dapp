...
## 솔리디티 보안 취약점과 외부 호출 관련 위험 요소

솔리디티 언어에서 특정한 제한 사항은 주의해야 합니다. 보안의 취약점이 될 수 있기 때문입니다.
특정한 제한 사항은 다음과 같습니다.

- 데이터 프라이버시 : 프라이버시가 필요하면 데이터 평문이 아닌 암호화된 형태로 저장해야 합니다.
- 무작위성 : 일부 디앱은 무작위로 작동해야합니다. 의사 난수 발생기(Pseudo-random generator)의 난수를 예측해 조작의 위험을 피해야 합니다.
- 뷰 함수 : View로 정의된 함수가 상태 변수를 수정할 수 있다는 점에 유의해야 합니다.
- 가스 한도 : 트랜잭션의 가스 한도를 설정할 때 주의해야 합니다. 가스 한도가 높거나 낮은 것을 악용할 수 있습니다.
- - -
